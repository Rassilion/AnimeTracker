...
public class Profile implements Serializable {
    ...
    public String getSpecialAccesRank(String username) {
        if (getDetails() != null && getDetails().getAccessRank() != null) {
            ...
            if (rank.contains("IRC"))
                ...
                return "Admin";
            else if (com.denizkemal.animetracker.api.BaseModels.Profile.isDeveloper(username))
                return "Atarashii dev";
        }
        if (com.denizkemal.animetracker.api.BaseModels.Profile.isDeveloper(username))
            return "Atarashii dev";
        return "";
    }
    ...
    public com.denizkemal.animetracker.api.BaseModels.Profile createBaseModel() {
    ...
    public static ArrayList<com.denizkemal.animetracker.api.BaseModels.Profile> convertBaseList(ArrayList<Profile> MALprofiles) {
