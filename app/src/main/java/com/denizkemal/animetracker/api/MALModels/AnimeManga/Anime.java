...
public class Anime extends GenericRecord implements Serializable {
     ...
     */
    @Getter @SerializedName("opening_theme") private ArrayList<String> openingTheme;

    /**
     * Ending themes of the record
     */
    @Getter @SerializedName("ending_theme") private ArrayList<String> endingTheme;
     ...
     */
    @Getter private String broadcast;

    /**
     * Beginning date from which this anime was/will be air.
     */
    @Getter @SerializedName("start_date") private String startDate;

    /**
     * Airing end date for the anime
     */
    @Getter @SerializedName("end_date") private String endDate;
     ...
     */
    @Getter private String classification;

    /**
     * A list of producers for the anime
     */
    @Getter private ArrayList<String> producers;

    /**
     * A list of characters
     */
    @Getter @SerializedName("character_anime") private ArrayList<RecordStub> characterAnime;

    /**
     * A list of manga adaptations of this anime (or conversely, manga from which this anime is adapted).
     */
    @Getter @SerializedName("manga_adaptations") private ArrayList<RecordStub> mangaAdaptations;

    /**
     * A list of anime prequels of this anime.
     */
    @Getter private ArrayList<RecordStub> prequels;

    /**
     * A list of anime sequels of this anime.
     */
    @Getter private ArrayList<RecordStub> sequels;

    /**
     * A list of anime side stories of this anime.
     */
    @Getter @SerializedName("side_stories") private ArrayList<RecordStub> sideStories;

    /**
     * Parent story of this anime.
     */
    @Getter @SerializedName("parent_story") private RecordStub parentStory;

    /**
     * A list of spin-offs of this anime.
     */
    @Getter @SerializedName("spin_offs") private ArrayList<RecordStub> spinOffs;

    /**
     * A list of summaries of this anime.
     */
    @Getter private ArrayList<RecordStub> summaries;

    /**
     * A list of other related animes.
     */
    @Getter private ArrayList<RecordStub> other;
     ...
     * The fansub group the user used, if any
     */
    @Getter @SerializedName("preview") private String preview;
    ...
    public com.denizkemal.animetracker.api.BaseModels.AnimeManga.Anime createBaseModel() {
        com.denizkemal.animetracker.api.BaseModels.AnimeManga.Anime model = new com.denizkemal.animetracker.api.BaseModels.AnimeManga.Anime();
        com.denizkemal.animetracker.api.BaseModels.AnimeManga.GenericRecord.setFromCursor(true);
        createGeneralBaseModel(model);

        model.setExternalLinks(new com.denizkemal.animetracker.api.BaseModels.AnimeManga.Anime.externalLinks());
        ...
        if (getExternalLinks() != null) {
            if (getExternalLinks().getOfficialSite() != null)
                model.getExternalLinks().setOfficialSite(getExternalLinks().getOfficialSite());
            if (getExternalLinks().getAnimeDB() != null)
                model.getExternalLinks().setAnimeDB(getExternalLinks().getAnimeDB());
            if (getExternalLinks().getAnimeNewsNetwork() != null)
                model.getExternalLinks().setAnimeNewsNetwork(getExternalLinks().getAnimeNewsNetwork());
            if (getExternalLinks().getWikipedia() != null)
                model.getExternalLinks().setWikipedia(getExternalLinks().getWikipedia());
        }
        com.denizkemal.animetracker.api.BaseModels.AnimeManga.GenericRecord.setFromCursor(false);
        return model;
    }
}
