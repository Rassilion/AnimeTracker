...
import com.denizkemal.animetracker.api.MALModels.AnimeManga.Reviews;
import com.denizkemal.animetracker.api.MALModels.AnimeManga.Schedule;
...
/*
    ...
    Call<ArrayList<com.denizkemal.animetracker.api.MALModels.Friend>> getFriends(@Path("username") String username);
    ...
    Call<ArrayList<com.denizkemal.animetracker.api.MALModels.History>> getActivity(@Path("username") String username);
