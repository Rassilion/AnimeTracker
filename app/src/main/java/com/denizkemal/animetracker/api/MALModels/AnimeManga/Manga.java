...
public class Manga extends GenericRecord implements Serializable {
    ...
    public com.denizkemal.animetracker.api.BaseModels.AnimeManga.Manga createBaseModel() {
        com.denizkemal.animetracker.api.BaseModels.AnimeManga.Manga model = new com.denizkemal.animetracker.api.BaseModels.AnimeManga.Manga();
